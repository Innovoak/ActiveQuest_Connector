...
public class registerPage implements ActionListener {
	...
	public registerPage() {
		...
		dob.setModel(new DefaultComboBoxModel(
		...
		mob.setModel(new DefaultComboBoxModel(
		...
		yob.setModel(new DefaultComboBoxModel(new String[] { "2023", "2022", "2021", "2020", "2019", "2018", "2017",
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == create_account) {
			...
			if (name.isEmpty() || username.isEmpty() || email.isEmpty()) {
				JOptionPane.showMessageDialog(createAccount, "Please enter all of the required fields", "Error",
			...
			try {
				...
				if (profiles.size() == 0 && users.size() == 0) {
					...
					JOptionPane.showMessageDialog(createAccount, "An account has already been created with this email.",
							"Error", JOptionPane.ERROR_MESSAGE);
				} else if (users.size() == 0) {
					JOptionPane.showMessageDialog(createAccount, "An account with this username already exists.",
							"Error", JOptionPane.ERROR_MESSAGE);
				}
